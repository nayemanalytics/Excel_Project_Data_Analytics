...
- The Workbooks to solve practice problems
    - [Purchase the problems here](https://lukebarousse.com/excel)### [Chapter 1: Spreadsheets_Intro](/1_Spreadsheets_Intro/)
- Worksheets
- Workbooks
- Ribbon
- Menu
...
- Pivot Tables
- Pivot Charts
- Pivot Tables Advanced### [Chapter 6: Advanced Data Analysis](/6_Advanced_Data_Analysis/)
- Analysis Add-ins
- Solver
- Scenario Manager
- Goal Seek
